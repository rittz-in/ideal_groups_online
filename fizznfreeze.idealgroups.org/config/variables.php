...
return [
  ...
  "livePreview" => "https://demos.pixinvent.com/parking system-html-admin-template/landing/",
  "productPage" => "https://1.envato.market/parking system_admin",
  "support" => "https://pixinvent.ticksy.com/",
  "moreThemes" => "https://1.envato.market/pixinvent_portfolio",
  "documentation" => "https://demos.pixinvent.com/parking system-html-admin-template/documentation",
  "generator" => "",
  "changelog" => "https://demos.pixinvent.com/parking system/changelog.html",
  "repository" => "https://github.com/pixinvent/parking system-html-admin-template",
  "gitRepo" => "pixinvent",
  "gitRepoAccess" => "parking system-html-admin-template",
