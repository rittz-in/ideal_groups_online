        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted text-center mb-5 w-75 m-auto">Invite your friend to
                        {{ config('variables.templateName') }}, if they sign up, you and your friend will get 30 days
                        free trial.</p>
                </div>
                <div class="row">
                ...
                <form class="row g-3" onsubmit="return false">
                    ...
                    <div class="col-lg-3 d-flex align-items-end">
                        <div class="btn-social">
                            <button type="button" class="btn btn-icon btn-facebook me-2"><i
                                    class="ti ti-brand-facebook"></i></button>
                            <button type="button" class="btn btn-icon btn-twitter me-2"><i
                                    class="ti ti-brand-twitter"></i></button>
                            <button type="button" class="btn btn-icon btn-linkedin"><i
                                    class="ti ti-brand-linkedin"></i></button>
                        </div>
                    </div>
                </form>
            </div>
