            ...
            <div class="d-none d-lg-flex col-lg-6 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    <img src="{{ asset('assets/img/illustrations/auth-register-illustration-' . $configData['style'] . '.png') }}"
                        ...
                        data-app-light-img="illustrations/register-img.png"
                        data-app-dark-img="illustrations/register-img.png">
                ...
                <div class="w-px-600 mx-auto ">
                    ...
                    <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            ...
                            {{-- Submit --}}
                            <button type="submit" class="btn btn-primary d-grid w-100" style="background-color: #842d44ff;">
                                Sign up
                            </button>
                        </div>
                    </form>
