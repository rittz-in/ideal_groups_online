...
use App\Http\Controllers\apps\CategoriesController;
use App\Http\Controllers\apps\ProductsController;
use App\Http\Controllers\apps\TablesController;
...
Route::post('/app/roles/store', [AccessRoles::class, 'store'])->name('app-access-roles.store');
// routes/web.php

// routes/web.php

Route::get('/app/users', [UserList::class, 'index'])->name('users.index');
Route::post('/app/users', [UserList::class, 'store'])->name('users.store');
Route::put('/app/users/{user}', [UserList::class, 'update'])->name('users.update');
Route::get('/app/users/{user}/edit', [UserList::class, 'edit'])->name('users.edit');
Route::delete('/app/users/{user}', [UserList::class, 'destroy'])->name('users.destroy');
...
//frontend home and product route
Route::get('/home/{table?}', [HomeController::class, 'index'])->name('homee');
Route::get('/product/{category?}/{table?}', [HomeController::class, 'product'])->name('product');
Route::get('/product-detail/{id}/{table?}', [HomeController::class, 'productDetail'])->name('product-detail');
Route::get('/search-products', [HomeController::class, 'search'])->name('search-products');
Route::get('/cart/{table?}', function () {
...
Route::middleware(['auth'])
  ...
  ->group(function () {
    ...
    Route::get('site-users/getAllSiteUsers', [UsersController::class, 'getAllSiteUsers'])->name(
      'app-site-users-get-all'
    );

    //categories
    Route::get('categories/list', [CategoriesController::class, 'index'])->name('app-categories-list');
    Route::get('categories/add', [CategoriesController::class, 'create'])->name('app-categories-add');
    Route::post('categories/store', [CategoriesController::class, 'store'])->name('app-categories-store');
    Route::get('categories/edit/{encrypted_id}', [CategoriesController::class, 'edit'])->name('app-categories-edit');
    Route::put('categories/update/{encrypted_id}', [CategoriesController::class, 'update'])->name(
      'app-categories-update'
    );
    Route::get('categories/destroy/{encrypted_id}', [CategoriesController::class, 'destroy'])->name(
      'app-categories-destroy'
    );
    Route::get('categories/getAll', [CategoriesController::class, 'getAll'])->name('app-categories-get-all');

    //products
    Route::get('products/list', [ProductsController::class, 'index'])->name('app-products-list');
    Route::get('products/add', [ProductsController::class, 'create'])->name('app-products-add');
    Route::post('products/store', [ProductsController::class, 'store'])->name('app-products-store');
    Route::get('products/edit/{encrypted_id}', [ProductsController::class, 'edit'])->name('app-products-edit');
    Route::put('products/update/{encrypted_id}', [ProductsController::class, 'update'])->name('app-products-update');
    Route::get('products/destroy/{encrypted_id}', [ProductsController::class, 'destroy'])->name('app-products-destroy');
    Route::get('products/delete-image/{encrypted_id}', [ProductsController::class, 'deleteImage'])->name(
      'app-products-delete-image'
    );
    Route::get('products/getAll', [ProductsController::class, 'getAll'])->name('app-products-get-all');
    Route::post('products/update-status', [ProductsController::class, 'updateStatus'])->name(
      'app-products-update-status'
    );

    //tables
    Route::get('tables/list', [TablesController::class, 'index'])->name('app-tables-list');
    Route::get('tables/add', [TablesController::class, 'create'])->name('app-tables-add');
    Route::post('tables/store', [TablesController::class, 'store'])->name('app-tables-store');
    Route::get('tables/edit/{encrypted_id}', [TablesController::class, 'edit'])->name('app-tables-edit');
    Route::put('tables/update/{encrypted_id}', [TablesController::class, 'update'])->name('app-tables-update');
    Route::get('tables/destroy/{encrypted_id}', [TablesController::class, 'destroy'])->name('app-tables-destroy');
    Route::get('tables/getAll', [TablesController::class, 'getAll'])->name('app-tables-get-all');
    Route::get('tables/qr/{encrypted_id}', [TablesController::class, 'showQrCode'])->name('app-tables-qr');
    Route::get('tables/qr-download/{encrypted_id}', [TablesController::class, 'downloadQrCode'])->name(
      'app-tables-qr-download'
    );
    Route::get('tables/print-all-qr', [TablesController::class, 'printAllQrCodes'])->name('app-tables-print-all-qr');
    Route::get('tables/payment-qr', [TablesController::class, 'paymentQr'])->name('app-tables-payment-qr');
    Route::post('tables/payment-qr-update', [TablesController::class, 'updatePaymentQr'])->name(
      'app-tables-payment-qr-update'
    );
    Route::post('tables/generate-payment-qr', [TablesController::class, 'generatePaymentQr'])->name(
      'app-tables-generate-payment-qr'
    );
    Route::delete('tables/payment-qr-delete', [TablesController::class, 'deletePaymentQr'])->name(
      'app-tables-payment-qr-delete'
    );

    //orders
    Route::get('orders/list', [\App\Http\Controllers\apps\OrdersController::class, 'index'])->name('app-orders-list');
    Route::get('orders/getAll', [\App\Http\Controllers\apps\OrdersController::class, 'getAll'])->name(
      'app-orders-get-all'
    );
    Route::get('orders/view/{encrypted_id}', [\App\Http\Controllers\apps\OrdersController::class, 'view'])->name(
      'app-orders-view'
    );
    Route::post('orders/update-status/{encrypted_id}', [
      \App\Http\Controllers\apps\OrdersController::class,
      'updateStatus',
    ])->name('app-orders-update-status');
    Route::post('orders/update-payment/{encrypted_id}', [
      \App\Http\Controllers\apps\OrdersController::class,
      'updatePayment',
    ])->name('app-orders-update-payment');
    Route::get('orders/generate-upi-qr/{encrypted_id}', [
      \App\Http\Controllers\apps\OrdersController::class,
      'generateUpiQr',
    ])->name('app-orders-generate-upi-qr');
    Route::get('orders/print/{encrypted_id}', [\App\Http\Controllers\apps\OrdersController::class, 'print'])->name(
      'app-orders-print'
    );
    Route::get('orders/statistics', [\App\Http\Controllers\apps\OrdersController::class, 'statistics'])->name(
      'app-orders-statistics'
    );
    Route::get('orders/kitchen', [\App\Http\Controllers\apps\OrdersController::class, 'kitchen'])->name(
      'app-orders-kitchen'
    );
    Route::get('orders/active', [\App\Http\Controllers\apps\OrdersController::class, 'getActiveOrders'])->name(
      'app-orders-active'
    );
    Route::post('orders/cancel-item/{encrypted_id}', [
      \App\Http\Controllers\apps\OrdersController::class,
      'cancelItem',
    ])->name('app-orders-cancel-item');

    //customers listing
    Route::get('customers/list', [CustomerController::class, 'index'])->name('app-orders-customers-list');
    Route::get('customers/getAll', [CustomerController::class, 'getAll'])->name('app-customers-get-all');
    Route::get('customers/export/pdf', [CustomerController::class, 'exportPdf'])->name('app-customers-export-pdf');
    Route::delete('customers/destroy/{mobile}', [CustomerController::class, 'destroy'])->name('app-customers-destroy');

    // Sales Reports
    Route::get('reports/sales', [ReportController::class, 'index'])->name('app-reports-sales');
    Route::get('reports/sales/data', [ReportController::class, 'salesData'])->name('app-reports-sales-data');
    Route::get('reports/sales/export/excel', [ReportController::class, 'exportExcel'])->name(
      'app-reports-sales-export-excel'
    );
    Route::get('reports/sales/export/pdf', [ReportController::class, 'exportPdf'])->name(
      'app-reports-sales-export-pdf'
    );
...
Route::post('/order/continues', [\App\Http\Controllers\OrderController::class, 'ordrContinues'])->name('order-continue');

Route::get('/order/status/{orderNumber}', [\App\Http\Controllers\OrderController::class, 'status'])->name(
  'order-status'
);
Route::post('/order/cancel/{orderNumber}', [\App\Http\Controllers\OrderController::class, 'cancel'])->name(
  'order-cancel'
);
Route::get('/order/my-orders/{mobile}', [\App\Http\Controllers\OrderController::class, 'myOrders'])->name(
  'order-my-orders'
);
Route::get('/checkout/{table?}', [\App\Http\Controllers\OrderController::class, 'checkout'])->name('checkout');
Route::get('/order/confirmation/{orderNumber}', [\App\Http\Controllers\OrderController::class, 'confirmation'])->name(
  'order-confirmation'
);
Route::get('/track-order', [\App\Http\Controllers\OrderController::class, 'trackOrder'])->name('track-order');

// Look up active order by table number (for QR scan on shared table)
Route::get('/order/table-active/{tableNumber}', [\App\Http\Controllers\OrderController::class, 'tableActiveOrder'])->name('order-table-active');


Route::get('/order/payment/{orderNumber}', [\App\Http\Controllers\OrderController::class, 'payment'])->name(
  'order-payment'
);

Route::get('/order/pay/{orderNumber}', [\App\Http\Controllers\OrderController::class, 'payPayment'])->name(
  'order-pay-payment'
);


Route::get('orders/payment_generate-upi-qr/{encrypted_id}', [
  \App\Http\Controllers\OrderController::class,
  'paymentgenerateUpiQr',
])->name('order-pay-payment-upi-qr');

Route::post('order/confirm-upi-payment/{encrypted_id}', [
  \App\Http\Controllers\OrderController::class,
  'confirmUpiPayment',
])->name('order-confirm-upi-payment');

/*
|--------------------------------------------------------------------------
| Storage File Route (fallback for when symlink doesn't work over local IP)
|--------------------------------------------------------------------------
| Serves files from storage/app/public directly via the web.
| Usage: /storage-file/products/image.jpg  → storage/app/public/products/image.jpg
*/
...
/*
|--------------------------------------------------------------------------
| Remote Storage:Link Route
|--------------------------------------------------------------------------
| Hit this URL to run `php artisan storage:link` on the server.
| Protected by a secret token — pass ?token=YOUR_APP_KEY_FIRST_16_CHARS
|
| Example:
|   https://yourdomain.com/run-storage-link?token=base64:AbCdEfGhIj...
|
| The token must match the first 32 characters of your APP_KEY value.
*/
Route::get('/run-storage-link', function (\Illuminate\Http\Request $request) {
  // Token = first 32 chars of APP_KEY (strip the "base64:" prefix if present)
  $appKey = config('app.key');
  $rawKey = str_replace('base64:', '', $appKey);
  $expectedToken = substr($rawKey, 0, 32);
