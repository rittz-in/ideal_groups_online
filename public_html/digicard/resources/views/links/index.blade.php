                ...
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <input type="text" id="facebook" class="form-control" name="facebook"
                            placeholder="Enter Facebook Link" value="{{ $links->facebook ?? '' }}">
                        @error('facebook')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <input type="text" id="instagram" class="form-control" name="instagram"
                            placeholder="Enter instagram Link" value="{{ $links->instagram ?? '' }}">
                        @error('instagram')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <input type="text" id="linkedin" class="form-control" name="linkedin"
                            placeholder="Enter linkedin Link" value="{{ $links->linkedin ?? '' }}">
                        @error('linkedin')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <input type="text" id="pinterest" class="form-control" name="pinterest"
                            placeholder="Enter pinterest Link" value="{{ $links->pinterest ?? '' }}">
                        @error('pinterest')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
