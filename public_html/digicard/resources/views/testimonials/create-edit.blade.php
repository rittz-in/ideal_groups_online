                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="author"
                            value="{{ old('author') ? old('author') : ($testimonial ? $testimonial->author : '') }}"
                        ...
                        @if ($testimonial && $testimonial->image)
                            ...
                            <div class="mt-3">
                                ...
                                @if (!empty($testimonial->image))
                                    <a class="click-testimonials ms-5"
                                        href="{{ route('member.remove_image_testimonials', $testimonial->id) }}"><i
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="designation"
                            value="{{ old('designation') ? old('designation') : ($testimonial ? $testimonial->designation : '') }}"
