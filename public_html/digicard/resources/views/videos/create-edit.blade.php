                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="Title"
                            value="{{ old('title') ? old('title') : ($video ? $video->title : '') }}">
                        @error('title')
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="youtube_link" class="form-control" id="youtube_link"
                            ...
                            value="{{ old('youtube_link') ? old('youtube_link') : ($video ? $video->youtube_link : '') }}">

                        <small class="form-text text-muted fw-bold">
                            Please Selcct iframe From Youtube<span class="text-danger">"iframe width : 444 height :
                                323"</span>
                        </small>
