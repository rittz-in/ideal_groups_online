<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0" href=" " target="_blank">
            <span class="font-weight-bold text-lg">km</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link  {{ is_current_route('RTL') ? 'active' : '' }}" href="">
            ...
            */
            ...
            <li class="nav-item">
                {{-- <a class="nav-link {{ is_current_route('wallet') ? 'active' : '' }} " href="{{ route('wallet') }}"> --}}
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('order.index') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                {{-- <a class="nav-link {{ is_current_route('wallet') ? 'active' : '' }} " href="{{ route('wallet') }}"> --}}
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('category.index') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('product.index') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('product_variants.index') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Product Variants</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('coupon_code.index') ? 'active' : '' }}"
                    href="{{ route('coupon_code.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Coupon Code</span>
                </a>
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">User Masters</span>
                </div>
            </li>
