                    ...
                    <div class="card-body">
                        <div class="row p-3">
                            ...
                            <div class="col-md-6 productSection">
                                ...
                                <h6>&#8377;{{ $productRanges['min_price'] }} - &#8377;{{ $productRanges['max_price'] }}
                                </h6>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button"
                                            ...
                                            data-id="{{ $varients_type->id }}" data-product="{{ $products->id }}">{{
                                            $varients_type->variant_sizes }}
                                    </div>
                                    @endif
                                    @endforeach
                                ...
                                <div class="col-md-6 mt-2 mb-4 quantity">
                                    ...
                                    <input type="number" name="quntity" class="input-box" id="quntity" value="1" min="1"
                                        max="10">
                                ...
                                <div class="row g-0">
                                    <div class="col-3 p-0">
                                        <a href="{{ route('product.AddtoCart') }}"
                                            ...
                                            data-productId="{{ $products->id }}">Add to
                                            Cart</a>
                                    </div>

                                    <div class="col-3 p-0">
                                        <a class="btn buyNow btn-sm btn-block mb-2 ml-4" data-id="buy_cart">Buy Now</a>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0">
                                    <div class="col-3 p-0 viewCartSection" style="display:none;">
                                        <a href="{{ route('app-product-view-tempcart-details') }}"
                                            class="btn btn-warning btn-sm viewCart btn-block mb-2">View Cart (<span
...
<section class="container my-3 pt-5">
    <div class="row mt-3 ">
        <div class="col-lg-6 col-md-12">
            ...
            @if ($index == 0)
            <img src="{{ asset($productsImage->images) }}" alt="" class="img-fluid w-100 pb-1 rounded-3 " id="big-img">
            <div class="row img-group mt-3">
                <div class="sml-img">
                    <img src="{{ asset($productsImage->images) }}" alt="" width="100%" class="tmb-img rounded-2">
                </div>
                @else
                <div class="sml-img">
                    <img src="{{ asset($productsImage->images) }}" alt="" width="100%" class="tmb-img rounded-2">
        ...
        <div class="col-lg-6 col-md-12 mt-5 ps-0 right-col">
            ...
            <div class="row g-0 ms-5">
                ...
                @endif
                <div class="col">
                    <button type="button" class="btn btn-warning btn-sm btn-block mb-2 variant-button {{ $classType }}"
                        data-id="{{ $varients_type->id }}" data-product="{{ $products->id }}">{{
                        $varients_type->variant_sizes }}
                </div>
                @endif
            ...
            <div class="product-counter dis-flex ms-5">
                <div class="dis-flex group2 me-3 mt-5">
                    <img onclick="decriment()" src="{{ asset('siteassets/images/product/icon-minus.svg') }}" alt=""
                        id="minus">
                    <div class="count">1</div>
                    <img onclick="incriment()" src="{{ asset('siteassets/images/product/icon-plus.svg') }}" alt=""
                        id="plus">
                </div>
...
<div class="cart-projection none" id="cart">
    ...
    <div class="cart-second-row dis-flex none">
        <div><img src="{{ asset('siteassets/images/product/image-product-1-thumbnail.jpg') }}" alt="" class="cart-img">
        </div>
        <div>
            <p>Fall Limited Edition Sneakers</p>
            <h3>$125.00 X <span id="num">1</span><span id="total"> $375</span></h3>
        </div>
        <div><img onclick="deltcart()" src="{{ asset('siteassets/images/product/icon-delete.svg') }}" alt="">
        </div>
    </div>
