...
class Front extends BaseController
{
        public function index()
        {
                ...
                $this->data['categories_datas'] = $this->admin_category_model->where($where)->findAll();
        ...
        public function contact()
        {
                ...
                if (!empty($this->request->getVar())) {
                        $input = $this->validate([
                                'name' => ['label' => lang('Common.name'), 'rules' => 'required'],
                                'email' => ['label' => lang('Common.email'), 'rules' => 'required'],
                                'phone' => ['label' => lang('Common.phone'), 'rules' => 'required'],
                                'message' => ['label' => lang('Common.message'), 'rules' => 'required'],
                        ]);
