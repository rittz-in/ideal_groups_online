...
<div class="post d-flex flex-column-fluid" id="kt_post">
    <div id="kt_content_container" class="container">
        ...
        <?php
			...
			if($donate['id']!='')
            {
                $button_name = $donate['button_name'];
				$url = $donate['url'];
		        $description = $donate['description'];
                $image = $donate['image'];
                $status = ($donate['is_active'] == 'active') ? 'checked="checked"' : '';
            }
            ...
            $hidden     = array();
            echo form_open(route_to('donate_edit_url'), $attributes, $hidden);
        ?>
									...
									<label class="col-form-label fw-bold fs-6"><?=lang("Common.image")?></label>
										<div class="fv-row">
											<?php 
												...
												{ 
												?>
												<img src="<?php echo base_url().'/assets/uploads/home-section/donate/'.$image; ?>" style="max-width:100px;height:100px;" /> 
												<?php 
												}
