<div id="kt_header" style="" class="header align-items-stretch">
   <div class="container-fluid d-flex align-items-stretch justify-content-between">
      ...
      <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
         ...
         <img alt="Logo" src="<?php echo $admin_assets_path; ?>media/logos/logo.png" class="h-30px" />
         </a>
      </div>
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
               <!-- <div class="d-flex align-items-center ms-1 ms-lg-3">
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                      <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('<?php echo $admin_assets_path; ?>media/misc/pattern-1.jpg')">
               ...
               <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                  <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                     <img src="<?php echo $admin_assets_path; ?>media/avatars/blank.png" alt="metronic" />
                  </div>
                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                     ...
                     <!-- <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-kt-menu-flip="bottom">
                        <a href="#" class="menu-link px-5">
                            ...
                            <img class="w-15px h-15px rounded-1 ms-2" src="<?php echo $admin_assets_path; ?>media/flags/united-states.svg" alt="metronic" /></span></span>
                        </a>
                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                            <div class="menu-item px-3">
                                <a href="account/settings.html" class="menu-link d-flex px-5 active">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="<?php echo $admin_assets_path; ?>media/flags/united-states.svg" alt="metronic" />
                                </span>English</a>
                            </div>
                     ...
                     <div class="menu-item px-5">
                        <?=anchor(route_to('logout_url'), lang("Common.logout"), 'title="'.lang("Common.logout").'" class="menu-link px-5"');?>
                     </div>
                  </div>
               </div>
            </div>
