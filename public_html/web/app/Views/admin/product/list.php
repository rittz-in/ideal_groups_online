		...
		<div class="card mb-5 mb-xl-8">
			<div class="card-header border-0 pt-5">
				<h3 class="card-title align-items-start flex-column">
					<span class="card-label fw-bolder fs-3 mb-1"><?=lang('Common.product_list')?></span>
				</h3>
				<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a Product">
					<?=anchor(route_to('product_add_url'), '<span class="svg-icon svg-icon-3">
					...
					</span> '.lang('Common.add_product'), 'title="'.lang("Common.product").'" class="btn btn-sm btn-light-primary"');?>
				</div>
			</div>
			<div class="card-body py-3">
				<div class="d-flex align-items-center position-relative my-1">
					...
					<input type="text" class="form-control form-control-solid w-250px ps-14" id="global_search" autofocus="" placeholder="Search Products">
				</div>
